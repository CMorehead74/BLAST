...
const TCHAR* g_szWINDOW_CLASS_NAME	= _T("SGP_GameProject");		//	Window Class Name.

const TCHAR* g_szWINDOW_TITLE		= _T("Blast");					//	Window Title.
...
BOOL RegisterWindowClass(HINSTANCE hInstance)
{
	...
	winClassEx.style			= CS_DBLCLKS | CS_OWNDC | CS_HREDRAW | CS_VREDRAW /*| WS_VISIBLE*/;
